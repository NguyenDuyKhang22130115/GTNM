function addFruit() {
  ...
  function editFruit() {
    ...
    // Lấy dữ liệu của hàng đang được sửa
    ...
    // Cập nhật dữ liệu trong biểu mẫu
    document.querySelector('.form_item input[type="name"]').value = name;
    document.querySelector('.form_item input[type="price"]').value = price;
    document.querySelector('.form_item input[type="quantity"]').value = quantity;
  
    // Ẩn nút Sửa, hiện nút Lưu
    const editButton = document.querySelector('.form .edit-btn');
